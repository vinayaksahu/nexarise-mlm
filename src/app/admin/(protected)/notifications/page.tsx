    ...
    <div className="space-y-6 max-w-4xl mx-auto animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-200 dark:border-slate-800 pb-4">
        <div>
          ...
          <p className="text-xs text-muted mt-1">Real-time system events, pending requests & operational alerts</p>
        </div>
      ...
      {loading ? (
        ...
        <Card className="p-8 text-center text-muted space-y-2">
          ...
          <p className="text-sm font-semibold text-gray-800 dark:text-slate-200">No admin notifications found</p>
